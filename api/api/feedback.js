      ...
      <html>
        ...
        <body style="margin:0;background:#071a33;color:white;font-family:Arial,sans-serif;text-align:center;padding:60px 20px;">
          <div style="max-width:520px;margin:auto;background:#10233f;border:1px solid #d4af37;border-radius:18px;padding:32px;">
            ...
            <p style="font-size:18px;">You rated your PenValue AI valuation ${ratingNumber} out of 5 stars.</p>
            <p>Your feedback helps us improve our valuations.</p>
            <a href="https://penvalueai.co.uk" style="display:inline-block;margin-top:18px;background:#d4af37;color:#071a33;text-decoration:none;font-weight:bold;padding:12px 18px;border-radius:10px;">
